...
[CmdletBinding(ConfirmImpact='High')]
    Param(
        ...
        # Table containing the entry we're modifying
        [parameter(mandatory=$true)]
        [parameter(ParameterSetName='SpecifyConnectionFields')]
        [parameter(ParameterSetName='UseConnectionObject')]
        [parameter(ParameterSetName='SetGlobalAuth')]
        ...
        # Values of the entry we're modifying
        [parameter(mandatory=$true)]
        [parameter(ParameterSetName='SpecifyConnectionFields')]
        [parameter(ParameterSetName='UseConnectionObject')]
        [parameter(ParameterSetName='SetGlobalAuth')]
    ...
    # Fire and return
    $Uri = $ServiceNowURL + "/table/$Table/$SysID"
    return (Invoke-RestMethod -Uri $uri -Method PATCH -Credential $ServiceNowCredential -Body (ConvertTo-JSON $Values) -ContentType "application/json").result
}

function Replace-ServiceNowTableEntry{
[CmdletBinding(ConfirmImpact='High')]
    Param(
        # sys_id of the entry we're modifying
        [parameter(mandatory=$true)]
    ...
    # Fire and return
    $Uri = $ServiceNowURL + "/table/$Table/$SysID"
    return (Invoke-RestMethod -Uri $uri -Method PUT -Credential $ServiceNowCredential -Body (ConvertTo-JSON $Values) -ContentType "application/json").result
}
